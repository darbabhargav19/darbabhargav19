# Hi 👋, I'm Darbha Bhargav

🎓 B.Tech ECE Graduate | Embedded Systems & IoT | Python Developer
...
## 📂 Projects
- 🌡️ [Python Sensor Logger](https://github.com/darbabhargav19/python-sensor-logger) — Real-time sensor data logging with alert detection
- ✅ [Python Task Manager](https://github.com/darbabhargav19/python-task-manager) — CLI task management application
